...
#OAUTH2_CLIENT_SECRET = config.get("client_secret") or None
...
def main(config):
    ...
    auth_code = config.get("auth_code") or None
    refresh_token = get_refresh_token(auth_code, client_id, client_secret)
...
def get_refresh_token(auth_code, client_id, client_secret):
    print(auth_code, client_id, client_secret)
    params = dict(
        code = auth_code,
